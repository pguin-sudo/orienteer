...
class UserDTO:
    ...
    async def from_user_id(cls, user_id: UUID) -> Optional["UserDTO"]:
        ...
        self.discord_user_id = await discord_auth.get_discord_user_id_by_user_id(self.user_id)
        return self
    ...
    async def from_discord_user_id(cls, discord_user_id: int) -> Optional["UserDTO"]:
        self = cls()
        self.user_id = await discord_auth.get_user_id_by_discord_user_id(discord_user_id)
        if self.user_id is None:
            return None
