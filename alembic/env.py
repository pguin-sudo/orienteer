...
config.set_section_option(section, "DB_PORT", POSTGRES_ORIENTEER_PORT)
config.set_section_option(section, "DB_USER", POSTGRES_ORIENTEER_USER)
config.set_section_option(section, "DB_NAME", POSTGRES_ORIENTEER_DBNAME)
config.set_section_option(section, "DB_PASS", POSTGRES_ORIENTEER_PASSWORD)
